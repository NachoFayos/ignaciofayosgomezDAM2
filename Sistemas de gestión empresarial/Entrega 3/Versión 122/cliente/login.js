	...
	console.log("Has pulsado el boton");
	  ...
	  .then(data => {
		 ...
		 if(data.length > 0){                                               // En el caso de que el login sea satisfactorio
		   ...
		   localStorage.setItem('bat2_usuario', data[0].usuario);       // Ahora necesito un mencanismo para que el cliente recuerde quien soy
		   localStorage.setItem('bat2_token',data[0].token)
