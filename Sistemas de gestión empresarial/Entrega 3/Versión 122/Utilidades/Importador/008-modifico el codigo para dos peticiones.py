...
print(diccionario['Nombre del cliente'][0])                                     # Compruebo que puedo acceder a cada uno de los datos
...
for i in range(0,2):
    ...
    for clave in diccionario:                                       # Repaso clave a clave el diccionario
        ...
        peticion += clave+"='"+str(diccionario[clave][i])+"',"      # Le añado al insert cada uno de los campos del diccionario
