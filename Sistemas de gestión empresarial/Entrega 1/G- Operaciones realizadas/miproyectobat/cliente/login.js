    ...
    document.querySelector("#login").onclick = function(){
        ...
        .then(data => {
          ...
          if(data.resultado == 'ok'){                   // En el caso de que el login sea satisfactorio
            ...
            localStorage.setItem('bat_usuario', data.usuario);       // Ahora necesito un mencanismo para que el cliente recuerde quien soy
            ...
            setTimeout(function(){
                window.location = "supercontrolador/index.html";                            // Me voy al supercontrolador                 
            },5000)
          }else{
